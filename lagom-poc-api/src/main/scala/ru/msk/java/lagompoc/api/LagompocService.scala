package ru.msk.java.lagompoc.api
...
object LagompocService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-poc service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagompocService.
  */
trait LagompocService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("lagom-poc")
      ...
      .withTopics(
        topic(LagompocService.TOPIC_NAME, greetingsTopic _)
